...
The same is true for [Controllers](https://github.com/CloudCIX/developers_manual/blob/main/style_guides/application_framework/layout/2-controllers.md) and [Permissions](https://github.com/CloudCIX/developers_manual/blob/main/style_guides/application_framework/layout/6-permissions.md), and anywhere else that uses these names.
...
See [Spans](https://github.com/CloudCIX/developers_manual/blob/main/style_guides/application_framework/style/3-spans.md) for more details.
